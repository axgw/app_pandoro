                        ...
                        child: Container(
                          ...
                          child: Padding (
                            ...
                            child: Column(
                              ...
                              children: [
                                BigText(text: "Tarta de Queso Vegano preparado a base de anacardos", size: 13),
                                SizedBox(height: Dimensions.height10),
                                SmallText(text: "A base de anacardos y leche de coco"),
                                SizedBox(height: Dimensions.height10),
                                Row(
          ...
          Align(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: const AppColumn(text: "Tarta de Zanahoria Vegana"),
              ),
            ),
          )
        ],
